                ...
                <div class="panel panel-default">
                                ...
                                <div class="col-md-12 column">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-6 column">
                                            <form role="form" id="confirmForm">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">易付宝企业账号：</label>
                                                    <input type="email" class="form-control" name="payCard" id="exampleInputEmail1"/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">法人身份证号：</label>
                                                    <input type="password" class="form-control" name="legalidCard" id="exampleInputPassword1"/>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="col-md-6 column" id="notice" style="display:none;">
                                            <div class="panel panel-default">
                                                <div class="panel-body" style="padding:40px;">
                                                    <i class="glyphicon glyphicon-user"></i>
                                                    易购账户名：<span id="count"><span><br><br><span style="margin-left:60px;">您正在使用该账号发起众筹项目</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-default btn-lg"
                                onclick="window.location.href='start-step-2.html'">上一步
                        </button>
                        <button type="button" id="submitData" class="btn  btn-warning btn-lg">提交
                        </button>
                        <a class="btn"> 保存草稿 </a>
                    </div>
                </div>
...
<script>
    ...
    $("#submitData").click(function () {
        ...
        $.ajax({
            url: "http://localhost:8081/api/project/confirmCard",
            type:"post",
            data: data+"&pid="+sessionStorage.pid,
