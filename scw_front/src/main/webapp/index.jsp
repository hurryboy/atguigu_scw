...
<head>
    ...
    <!-- 动态包含，两个页面都会被编译，把两个页面的运行结果合并一起；如果被包含页面的内容经常变换用动态包含  -->
    <%-- <jsp:include page=""></jsp:include> --%>
    <!-- 静态包含，被包含的内容会被复制到这里，只会产生一个编译的jsp（被包含的不会编译）；一般用静态包含 -->
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="${ctp }/static/index.html" style="font-size:32px;">尚筹网-创意产品众筹平台</a>
                </div>
                       ...
                       <c:when test="${login!=null}">
                           <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                               <ul class="nav navbar-nav">
                                   <li class="dropdown">
                                       <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> ${login.username}<span class="caret"></span></a>
                                       <ul class="dropdown-menu" role="menu">
                                           <li><a href="member.html"><i class="glyphicon glyphicon-scale"></i> 会员中心</a></li>
                                           <li><a href="#"><i class="glyphicon glyphicon-comment"></i> 消息</a></li>
                                           <li class="divider"></li>
                                           <li><a href="/member/logout"><i class="glyphicon glyphicon-off"></i> 退出系统</a></li>
                                       </ul>
                                   </li>
                               </ul>
                           </div>
                       </c:when>
                        <c:otherwise><ul class="nav navbar-nav navbar-right">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="left carousel-control" href="${ctp }/static/#myCarousel" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="${ctp }/static/#myCarousel" role="button" data-slide="next">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <p><a class="btn btn-default" href="${ctp }/static/project.html" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div class="box ui-draggable" id="mainBox">
                    <div class="mHd" style="">
                        <div class="path">
                            <a href="${ctp }/static/projects.html">更多...</a>
                        </div>
                        <h3>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${ctp }/static/project.html">活性富氢净水直饮机</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${ctp }/static/project.html">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${ctp }/static/project.html">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${ctp }/static/project.html">一款精致的机械表</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div id="footer">
                    <div class="footerNav">
                        <a rel="nofollow" href="${ctp }/static/http://www.atguigu.com">关于我们</a> | <a rel="nofollow" href="${ctp }/static/http://www.atguigu.com">服务条款</a> | <a rel="nofollow" href="${ctp }/static/http://www.atguigu.com">免责声明</a> | <a rel="nofollow" href="${ctp }/static/http://www.atguigu.com">网站地图</a> | <a rel="nofollow" href="${ctp }/static/http://www.atguigu.com">联系我们</a>
                    </div>
                    <div class="copyRight">
